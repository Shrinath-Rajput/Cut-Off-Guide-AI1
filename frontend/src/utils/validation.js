export const EXAM_CONFIG = {
  'MHT-CET PCM': {
    ...
    max: 200,
    type: 'marks',
    label: 'MHT-CET PCM Marks (Max 200)',
    description: 'Physics (50) + Chemistry (50) + Mathematics (100) = 200 Marks (Engineering)',
    courses: [
  ...
  'MHT-CET': {
    ...
    description: 'Physics (50) + Chemistry (50) + Mathematics/Biology (100) = 200 Marks',
    courses: [
      'Computer Engineering (CSE)',
      'Information Technology (IT)',
      'Artificial Intelligence & Machine Learning',
