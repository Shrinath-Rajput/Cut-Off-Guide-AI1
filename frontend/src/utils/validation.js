export const EXAM_CONFIG = {
  'JEE Main': { min: 0, max: 300, type: 'marks', label: 'JEE Main Score', courses: ['CSE', 'IT', 'ECE', 'Mechanical', 'Civil', 'Electrical', 'Chemical', 'AI & ML', 'Data Science'] },
  'JEE Advanced': { min: 0, max: 360, type: 'marks', label: 'JEE Advanced Score', courses: ['CSE', 'IT', 'ECE', 'Mechanical', 'Civil', 'Electrical', 'Chemical', 'AI & ML', 'Data Science'] },
  'MHT-CET': { min: 0, max: 100, type: 'percentile', label: 'MHT-CET Percentile', courses: ['CSE', 'IT', 'ECE', 'Mechanical', 'Civil', 'Electrical', 'Chemical', 'AI & ML', 'Data Science'] },
