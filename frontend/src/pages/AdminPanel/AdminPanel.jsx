...
import { BarChart3, Database, Image, LayoutDashboard, LogOut, Menu, MessageSquare, Pencil, Plus, Search, ShieldCheck, Trash2, Users, X } from 'lucide-react';
...
const Actions = ({ onEdit, onDelete }) => <div className="row-actions">{onEdit && <button title="Edit" onClick={onEdit}><Pencil size={16} /></button>}{onDelete && <button title="Delete" onClick={onDelete}><Trash2 size={16} /></button>}</div>;
